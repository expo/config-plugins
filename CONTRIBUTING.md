...
2. Run `bun install` in the root directory to generate the build files.
...
- Plugins can be generated by running `bun gen`.
...
- Update dependabot: `bun update-dependabot-config`
- Update the issue template: `bun update-issue-template`

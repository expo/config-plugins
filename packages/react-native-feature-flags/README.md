...
If a flag name doesn't exist in the installed React Native version, the native build will fail with a compile error — remove the unrecognized flag to fix.

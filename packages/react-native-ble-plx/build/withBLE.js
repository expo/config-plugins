...
const withBluetoothAlwaysPermission_1 = require("./withBluetoothAlwaysPermission");
...
const withBLE = (config, props = {}) => {
    ...
    // iOS
    config = withBluetoothAlwaysPermission_1.withBluetoothAlwaysPermission(config, _props);

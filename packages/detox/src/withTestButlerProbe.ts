...
/**
 * Copied from the [react native demo](https://github.com/wix/Detox/blob/master/examples/demo-react-native/android/app/src/androidTest/java/com/example/TestButlerProbe.java).
 *
...
const withTestButlerProbe: ConfigPlugin = (config) => {
  return withDangerousMod(config, [
    ...
    async (config) => {
      ...
      fs.writeFileSync(
        path.join(folder, 'TestButlerProbe.java'),
...
export default withTestButlerProbe;
